	...
	<div class="w3-container">
		...
		<div class="w3-panel w3-bar w3-leftbar w3-text-dark-grey w3-border-red w3-pale-red">
			<h4 class="w3-bar-item">
				<i class="fa fa-object-group"></i><b> Funcionário - Grupos</b>
			</h4>
			<p>
				...
				<table id="id01" class="w3-table-all w3-striped w3-hoverable">
					...
					<c:forEach items="${funcionarios}" var="funcionario">					
						<tr class="item">								
							...
							<td class="w3-border">${funcionario.grupos}</td>
							<td class="w3-border w3-center">
							<a href="${spring:mvcUrl('show-funcionario-grupos').arg(0,funcionario.id).build()}">
